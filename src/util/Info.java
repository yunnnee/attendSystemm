...
public class Info {
	...
	{
	System.out.print(Info.daysBetween("2015-03-12 17:59:00","2015-03-12 12:00:00"));
	}
	    ...
	    public static String tform(HashMap map)
		{
	    	...
	    	jscode+="{\n";
	    	 ...
	    	 while(it.hasNext())
	    	 {
	    	  ...
	    	  jscode+="document.getElementById(\"txt\").src=\"/kaoqinmsys/upfile/"+map.get("filename")+"\";\n";
	    	  if(map.get("img")!=null)
		    	  jscode+="document.getElementById(\"txt\").src=\"/kaoqinmsys/upfile/"+map.get("img")+"\";\n";
	    	  jscode+="}\n";
