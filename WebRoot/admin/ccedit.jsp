...
HashMap map = dao.select("select * from ccinfo where id="+Integer.parseInt(id)).get(0);
 %>
<form action="/kaoqinmsys/kaoqinmsys?ac=ccinfoedit&id=<%=id %>" name="f1" method="post" onsubmit="return ck()">
