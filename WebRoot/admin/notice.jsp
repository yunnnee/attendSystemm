...
<form action="notice.jsp?f=f" name="f1" method="post">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr>
        <td height="30" align="center" bgcolor="d3eaef" class="STYLE10">标题</td>
        <td  height="30" align="center" bgcolor="d3eaef" class="STYLE10">内容概要</td>
 ...
 String hql = "select * from notice where 1=1 ";
        String url = "/kaoqinmsys/admin/notice.jsp?1=1";
         ...
         if(!key.equals(""))
         {
         hql+=" and (title like'%"+key+"%' or  content like'%"+key+"%' or savetime like'%"+key+"%' )";
         url+="&key="+key;
         }
   ...
   <%
      ...
      dao.commOper("delete from notice where id="+did);
	    ...
	    for(HashMap m :nlist)
	    {
         %>
      <tr>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=m.get("title") %></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">
		        <%String content = m.get("content").toString();
        if(content.length()>40){
        String content1 = content.substring(0,40)+"...";
        out.print(content1);
        }else{
         out.print(content);
        } %>
        ...
        &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
        <a href="notice.jsp?did=<%=m.get("id") %>" class="STYLE19" onclick="javascript:return ConfirmDel();" >删除</a> 
        </td>
        <%} %>
      </tr>
      <%} %>
