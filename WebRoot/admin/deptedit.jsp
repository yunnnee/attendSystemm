...
HashMap m = dao.select("select * from dept where id="+Integer.parseInt(id)).get(0);
 %>
<body>
<form action="/kaoqinmsys/kaoqinmsys?ac=deptedit" name="f1" method="post" >
<input type="hidden" id="id" name="id" value="<%=m.get("id") %>" />
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        <td height="31" align="center" bgcolor="#FFFFFF" class="STYLE19" colspan="2"><label><strong>编辑部门信息</strong></label></td>
        </tr>
      <tr>
      	<td height="15" align="center" bgcolor="#FFFFFF" class="STYLE19">部门名称</td>
        <td height="15"  bgcolor="#FFFFFF" class="STYLE19">
        <input type="text" id="deptname" name="deptname" size="40" value="<%=m.get("deptname") %>"/></td>
      </tr>
      <tr>
      	<td height="15" align="center" bgcolor="#FFFFFF" class="STYLE19">部门职责</td>
        <td height="15"  bgcolor="#FFFFFF" class="STYLE19">
        <input type="text" id="deptzz" name="deptzz" size="40" value="<%=m.get("deptzz") %>"/></td>
      </tr>
      <tr>
      	<td height="15" align="center" bgcolor="#FFFFFF" class="STYLE19">部门地址</td>
        <td height="15"  bgcolor="#FFFFFF" class="STYLE19">
        <input type="text" id="deptaddr" name="deptaddr" size="40" value="<%=m.get("deptaddr") %>"/></td>
      </tr>
	   <tr>
