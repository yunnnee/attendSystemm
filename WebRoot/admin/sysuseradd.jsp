...
<form action="/kaoqinmsys/kaoqinmsys?ac=useradd" name="f1" method="post" enctype="multipart/form-data" onsubmit="return checkk()">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onMouseOver="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <input name="upass" type="password" id="upass" size="10" />*
        </td>
        <td width="10%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">姓名</td>
        <td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"><label>
        <input name="realname" type="text" id="realname" size="10" />*</label></td>
        </tr>
        ...
        <td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"><label>
        <input name="birth" type="text" id="birth" size="10" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" readonly==true/>*</label></td>
        ...
        <input name="idcard" type="text" id="idcard" size="25" />*
        </td>
        </tr>
		<tr>
        ...
        <td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
        <input name="jg" type="text" id="jg" size="10" />
        </td>
	   ...
	   <tr>
        	...
        	<td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
        		<select id="dept" name="dept">
        			<option value="">请选择</option>
        			<%ArrayList<HashMap> deptlist = (ArrayList<HashMap>)dao.select("select * from dept "); 
        			for(HashMap m:deptlist){
        			%>
        			<option value="<%=m.get("id") %>"><%=m.get("deptname") %></option>
        			<%} %>
        		</select>*
        	</td>
        	...
        	<td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
        		<select id="zw" name="zw">
        			<option value="">请选择</option>
        			<%ArrayList<HashMap> zwlist = (ArrayList<HashMap>)dao.select("select * from zw "); 
        			for(HashMap m:zwlist){
        			%>
        			<option value="<%=m.get("id") %>"><%=m.get("zwname") %></option>
        			<%} %>
        		</select>*
        	</td>
	   </tr>
        ...
        <td  height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
        <input name="mz" type="text" id="mz" size="10" />
        </td>
