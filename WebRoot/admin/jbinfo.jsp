...
<%
 ...
 String hql = "select * from jbinfo where 1=1 ";
        String url = "/kaoqinmsys/admin/jbinfo.jsp?1=1";
 ...
 %>
<form action="jbinfo.jsp?f=f" name="f1" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 加班管理</span></td>
              </tr>
            </table></td>
            <td><div align="right">
            ...
            function add()
            {
            pop("jbadd.jsp","添加加班信息",600,253);
            }
            
             function update(no)
            {
            pop("jbedit.jsp?id="+no,"修改加班信息",600,253);
            }
            </script>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr>
        ...
        <td  height="30" align="center" bgcolor="d3eaef" class="STYLE10">加班日期</td>
        <td  height="30" align="center" bgcolor="d3eaef" class="STYLE10">加班时长</td>
   ...
   <%
      ...
      if(did!=null)
      {
      dao.commOper("delete from jbinfo where id="+did);
      }
      ...
      <tr>
        ...
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=m.get("jbdate") %></td>
        <td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=m.get("jbhour") %></td>
        ...
        &nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
        <a href="jbinfo.jsp?did=<%=m.get("id") %>" class="STYLE19" onclick="javascript:return ConfirmDel();" >删除</a> 
        </td>
      </tr>
      <%} %>
