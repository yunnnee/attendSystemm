...
HashMap user = (HashMap)session.getAttribute("admin");
	String hql = "select * from kqrecord where 1=1  ";
  String url = "/kaoqinmsys/admin/kqrecordAll.jsp?1=1";
...
%>
<form action="kqrecordAll.jsp?f=f" name="f1" method="post">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr>
        <td height="30" colspan="5" align="left" bgcolor="#FFFFFF" class="STYLE19">请输入时间段:
