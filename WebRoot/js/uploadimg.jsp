...
<LINK 
href="/kaoqinmsys/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/kaoqinmsys/admin/images/syscome.files/Admin.js"></SCRIPT>
<script type="text/javascript" src="/kaoqinmsys/js/popup.js"></script>
...
if(filename!=null)
{
 ...
 <%} %>
<form action="/kaoqinmsys/kaoqinmsys?ac=uploadimg" enctype="multipart/form-data" name="f1" method="post">
<TABLE cellSpacing=1 cellPadding=3 width="100%" align=center bgColor=#6ab6b6 
border=0>
 
   <TR>
    <TD align="center" class=forumrow><label>
    <strong>请选择文件</strong> </label>      <label>
    <br>
    <input name="txt" type="file"  size="40">
      </label></TD>
    </TR>
...
if(suc!=null)
{
 ...
 alert("操作成功");
  ...
  parent.location.replace("/kaoqinmsys/admin/<%=jsp%>");
 <%}%>
 </script>
